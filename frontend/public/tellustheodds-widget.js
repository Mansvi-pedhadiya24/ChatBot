(function (window, document) {
  ...
  style.textContent = [
    ...
    ".tuto-msg-wrap { display: flex; margin-bottom: 10px; animation: tuto-msgin .3s ease-out; }",
    ".tuto-msg-wrap.user { justify-content: flex-end; }",
    ".tuto-msg-wrap.bot  { justify-content: flex-start; }",
    ".tuto-bubble { max-width: 80%; padding: 10px 13px; font-size: 13px; line-height: 1.55; }",
