(function (window, document) {
  ...
  style.textContent = [
    ...
    "  padding: 16px 12px; background: #f8fafc; min-height: 0;",
    "}",
    ...
    /* Bubbles — match React app exactly */
    ".tuto-bubble {",
    ...
    "  #tuto-panel { width: calc(100vw - 20px); " + POS + ": -10px; height: 78vh; }",
    "}",
  ].join("\n");
