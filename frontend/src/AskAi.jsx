...
//       ...prev,
//       { type: "user", text, timestamp: now, id: Date.now() },
//     ]);
//     send(text);
//     setInput("");
//   };
...
//     <>
//       <style>{`
//         // @import url('https://fonts.googleapis.com/css2?family=Lora:wght@500;600&family=Open+Sans:wght@400;500;600&display=swap');
//         @font-face {
//           font-family: 'Open Sans';
//           src: url('https://fonts.gstatic.com/s/opensans/v44/memvYaGs126MiZpBA-UvWbX2vVnXBbObj2OVTSKmu1SC55K5gw.woff2') format('woff2');
//         }
//         :root {
//           --brand-navy: #4886ff;
//           --brand-gold: #f4f1e6;
